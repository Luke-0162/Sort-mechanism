...
class TestTaipy:
    ...
    def test_get_scenarios_sorted(self):
        scenario_1_cfg = Config.configure_scenario(name="B_scenario", id="scenario_3")
        scenario_2_cfg = Config.configure_scenario(name="C_scenario", id="scenario_1")
        scenario_3_cfg = Config.configure_scenario(name="A_scenario", id="scenario_2")
